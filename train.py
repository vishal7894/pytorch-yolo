...
class Yolo_loss(nn.Module):
    def __init__(self, n_classes=5, n_anchors=3, device=None, batch=2):
...
def train(model, device, config, epochs=5, batch_size=1, save_cp=True, log_step=20, img_scale=0.5):
    ...
    criterion = Yolo_loss(device=device, batch=1, n_classes=config.classes)
...
def get_args(**kwargs):
    ...
    parser.add_argument('-g', '--gpu', metavar='G', type=str, default='-1',
                        help='GPU', dest='gpu')
    parser.add_argument('-dir', '--data-dir', type=str, default="/home/vishal/project_invoice/pytorch-YOLOv4",
                        help='dataset dir', dest='dataset_dir')
    parser.add_argument('-pretrained', type=str, default="yolov4.conv.137", help='pretrained yolov4.conv.137')
